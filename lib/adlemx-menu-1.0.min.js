function t_menu__highlightActiveLinks(e) {
    ...
    Array.prototype.forEach.call(o, (function (e) {
        ...
        if (o) {
            var i = e.href;
            i !== t && i !== r && o !== t && o !== r && n !== t && n !== r || e.classList.add("t-active")
        }
    }))
}

function t_menu__findAnchorLinks(e, t) {
    var n = document.getElementById("rec" + e), r = t + '[href*="#"]:not(.tooltipstered)',
        o = n ? n.querySelectorAll(r) : [];
    o.length && t_menu__updateActiveLinks(o, t)
}
...
function t_menu__updateActiveLinks(e, t) {
    ...
    Array.prototype.forEach.call(a, (function (e) {
        ...
        t_menu__updateSectionsOffsets(o)
    }), 5e3), t_menu__highlightNavLinks(e, o, i, r), e.forEach((function (t, n) {
        t.addEventListener("click", (function () {
            var o = t_menu__getSectionByHref(t);
            !t.classList.contains("tooltipstered") && o && o.id && (e.forEach((function (e, t) {
                t === n ? e.classList.add("t-active") : e.classList.remove("t-active")
            })), r = o.id)
        }))
    })), window.addEventListener("scroll", t_throttle((function () {
        r = t_menu__highlightNavLinks(e, o, i, r)
    }), 100))
}
...
function t_menu__updateSectionsOffsets(e) {
    e.forEach((function (e) {
        ...
        e.setAttribute("data-offset-top", t.toString())
    }))
}
...
function t_menu__getSectionByHref(e) {
    if (e) {
        ...
        var r = t ? t.trim() : "", o = -1 !== r.indexOf("#") && r.indexOf("#");
        "number" == typeof o ? r = r.slice(o + 1) : "number" == typeof (o = -1 !== r.indexOf("/") && r.indexOf("/")) && (r = r.slice(o + 1));
        var i = '.r[data-record-type="215"] a[name="' + r + '"]';
        return document.querySelector(i) ? document.querySelector(i).closest(".r") : null
    }
}
    ...
    if (!(window.innerWidth <= 980) || r) {
        ...
        Array.prototype.forEach.call(i, (function (e) {
            var t = e.getAttribute("data-bgcolor-rgba"), n = e.getAttribute("data-bgcolor-rgba-afterscroll"),
                r = e.getAttribute("data-bgopacity"), o = e.getAttribute("data-bgopacity-two"),
                i = e.getAttribute("data-menushadow") || "0", a = "100" === i ? i : "0." + i;
            e.style.backgroundColor = window.pageYOffset > 20 ? n : t, window.pageYOffset > 20 && "0" === o || window.pageYOffset <= 20 && "0.0" === r || " " === i ? e.style.boxShadow = "none" : e.style.boxShadow = "0px 1px 3px rgba(0,0,0," + a + ")"
        }))
    }
}
...
function t_menu__createMobileMenu(e, t) {
    ...
    if (n) {
        var r = n.querySelector(t), o = r ? r.getAttribute("data-mobile-burgerhook") : "",
            i = n.querySelector(t + "__mobile"), a = i || n.querySelector(".tmenu-mobile"),
            l = i ? t.slice(1) + "_opened" : "tmenu-mobile_opened", s = "t-menuburger-opened";
        if (a) if (r && r.classList.contains(t.slice(1) + "__mobile_burgerhook") && o) {
            ...
            if (u) {
                ...
                d.href = o, c && (d.appendChild(u), c.appendChild(d))
            }
        } else {
...
| (_| |  __/\ V /  __/ | (_) | |_) |  __/ |    | (_| | (_| | |  __/ | | | | |>  <
 \__,_|\___| \_/ \___|_|\___/| .__/ \___|_|     \__,_|\__,_|_|\___|_| |_| |_/_/\_\
                             |_|
    */
                    if (a.classList.contains(l)) t_menu__FadeOut(r, 300), a.classList.remove(l), u.classList.remove(s); else if (t_menu__fadeIn(r, 300, (function () {
                        ...
                        var o = getComputedStyle(a).height;
                        r.style.top = o
                    }
        ...
        window.innerWidth < 980 && n.addEventListener("click", (function (n) {
            if (r && r.classList.contains("tmenu-mobile__menucontent_fixed")) {
                var o = n.target.closest(".t-menu__link-item, .t978__submenu-link, .t966__menu-link, .t-menusub__link-item, .t-btn"),
                    i, c;
                if (o) ["t978__menu-link_hook", "t978__tm-link", "t966__tm-link", "t794__tm-link", "t-menusub__target-link"].some((function (e) {
...
function t_menu_checkOverflow(e, t) {
    ...
    if (r) {
        var o = n.querySelector(t + "__mobile"), i = o || n.querySelector(".tmenu-mobile");
        if (i) {
            var a = i.offsetHeight, l = document.documentElement.clientHeight,
...
function t_menu__fadeIn(e, t, n) {
    ...
    var r = 0, o = (t = parseInt(t, 10)) > 0 ? t / 10 : 40;
    e.style.opacity = r, e.style.display = "block";
    var i = setInterval((function () {
        e.style.opacity = r, (r += .1) >= 1 && (e.style.opacity = "1", "function" == typeof n && n(), clearInterval(i))
    }), o)
}

function t_menu__slideElement(e, t, n) {
    var r = "toTop" === n ? 0 : t, o = "toTop" === n ? 1 : 0, i = setInterval((function () {
        e.style.transform = "translateY(-" + r + "px)", e.style.opacity = o.toString(), o = "toTop" === n ? o - .1 : o + .1, r = "toTop" === n ? r + t / 20 : r - t / 20, "toTop" === n && r >= t && (e.style.transform = "translateY(-" + t + "px)", e.style.opacity = "0", clearInterval(i)), "toBottom" === n && r <= 0 && (e.style.transform = "translateY(0px)", e.style.opacity = "1", clearInterval(i))
    }), 10)
}
...
function t_menu__interactFromKeyboard(e) {
    ...
    if (t) {
        var n = t.querySelectorAll('[role="menubar"] > li > a'), r = t.querySelectorAll('[role="menubar"]  > li li'),
            o = 9, i = 13, a = 27, l = 32, s = 37, u = 38, c = 39, d = 40, f = 0, m, _ = function (e) {
                ...
                e.addEventListener("keydown", (function (t) {
                    ...
                    switch (t.keyCode) {
                        ...
                        case s:
                            ...
                            break;
                        case o:
                            if (!t.shiftKey && f <= n.length - 2) _(f + 1); else {
                ...
                e.addEventListener("click", (function (n) {
                    if ("true" !== this.getAttribute("aria-haspopup") || "false" != this.getAttribute("aria-expanded") && null != this.getAttribute("aria-expanded")) this.setAttribute("aria-expanded", "false"); else {
                        this.setAttribute("aria-expanded", "true");
                        var r = e.nextElementSibling, o = r ? r.getAttribute("data-submenu-margin") : 0;
                        t_menusub__showSubmenu(e, t, o)
                    }
                ...
                e.addEventListener("keydown", (function (e) {
                    ...
                    switch (e.keyCode) {
                        case o:
                            ...
                            if (e.shiftKey) 0 === m ? (_(f), t_menusub__hideSubmenu(t)) : p(y, m - 1); else if (m === b - 1) {
