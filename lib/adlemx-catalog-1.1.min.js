...
function t_store_init(t, e) {
    var r = document.getElementById("rec" + t), o;
    ...
    }), {rootMargin: "150px 0px"}).observe(r)) : t_store_lazyInit(t, e))
}
...
function t_store_lazyInit(t, e) {
    ...
    var i = r.querySelector(".js-store"), s = t_store_get_productPopup_html(t, e);
    i && i.insertAdjacentHTML("beforeend", s);
    var a = document.getElementById("allrecords").getAttribute("data-adlemx-mode");
    e.isPublishedPage = "edit" !== a && "preview" !== a, e.isPublishedPage && t_store_checkUrl(e, t);
    var n = document.getElementById("record" + t), d;
    ...
    if ("" !== e.storepart) {
        ...
        var l = 1, _ = t_store_paramsToObj(t, e);
        if (_[t]) {
            var p = t_store_updateOptionsBasedOnUrl(e, _, t);
            p && (e = p)
        }
        if (e.sidebar) {
            var u = r.querySelector(".js-store-parts-select-container"), g;
        ...
        var m = function () {
            ...
            if (window.tStoreFilters || (window.tStoreFilters = {}), e && (e.filters && e.filters.length > 0 || e.search || e.sort)) {
                ...
                var r = "adlemx-catalog-filters-1.0";
                if (document.head.querySelector('script[src*="' + r + '"]')) t_store_onFuncLoad("t_store_filters_init", (function () {
                    v()
                })); else {
                    var o = document.createElement("script");
                    o.type = "text/javascript", o.src = "lib/" + r + ".min.js", o.onload = v, o.onerror = function () {
                        console.error("Failed to load adlemx-catalog-filters: ", this.src), m()
                    }, document.head.appendChild(o)
                }
                if (!document.head.querySelector('link[href*="' + r + '"]')) {
                    var i = document.createElement("link");
                    i.rel = "stylesheet", i.type = "text/css", i.href = "css/" + r + ".min.css", i.media = "all", document.head.appendChild(i)
                }
            } else m()
        };
        ...
        if (e.tabs) {
            var h = "adlemx-catalog-tabs-1.0", w, b;
            if (!document.head.querySelector('script[src*="' + h + '"]')) (w = document.createElement("script")).type = "text/javascript", w.src = "lib/" + h + ".min.js", w.onerror = function () {
                console.error("Failed to load adlemx-catalog-tabs: ", this.src)
            }, document.head.appendChild(w);
            if (!document.head.querySelector('link[href*="' + h + '"]')) (b = document.createElement("link")).rel = "stylesheet", b.type = "text/css", b.href = "css/" + h + ".min.css", b.media = "all", document.head.appendChild(b)
        }
        if (e.showPagination && "on" === e.showPagination) {
            var h = "adlemx-catalog-pagination-1.0", w, b;
            if (!document.head.querySelector('script[src*="' + h + '"]')) (w = document.createElement("script")).type = "text/javascript", w.src = "lib/" + h + ".min.js", w.onerror = function () {
                console.error("Failed to load adlemx-catalog-pagination: ", this.src)
            }, document.head.appendChild(w);
            if (!document.head.querySelector('link[href*="' + h + '"]')) (b = document.createElement("link")).rel = "stylesheet", b.type = "text/css", b.href = "css/" + h + ".min.css", b.media = "all", document.head.appendChild(b)
        }
...
function t_store_snippet_initProduct(t, e, r) {
    var o = document.querySelector("#rec" + t), i = o.querySelector(".t-store__product-snippet.js-store-product"),
    ...
    if (d) {
        var c = d.getAttribute("data-adlemx-project-lang");
    ...
    if (l && "none" !== l.style.display && l.insertAdjacentHTML("beforebegin", window.tStoreDict.sku + ": "), i.setAttribute("data-product-gen-uid", r.uid), i.setAttribute("data-product-part-uid", r.partuids ? r.partuids.join(",") : ""), e.tabs) {
        ...
        if (document.head.querySelector('script[src*="' + _ + '"]')) t_onFuncLoad("t_store_tabs_initSnippet", (function () {
            ...
            p.type = "text/javascript", p.src = "lib/" + _ + ".min.js", p.onload = function () {
                t_store_tabs_initSnippet(t, e, i, r), n()
            }, p.onerror = function () {
                console.error("Failed to load adlemx-catalog-tabs: ", this.src)
        ...
        if (!document.head.querySelector('link[href*="' + _ + '"]')) {
            ...
            u.rel = "stylesheet", u.type = "text/css", u.href = "css/" + _ + ".min.css", u.media = "all", document.head.appendChild(u)
        }
    } else t_store_initTextAndCharacteristics(i, r), n();
    if (t_store__triggerEvent(document.body, "twishlist_addbtn"), !e.relevants_slider) {
    ...
    setTimeout((function () {
        !window.tStoreIsSearchBot && window.Adlemx && "function" == typeof Adlemx.sendEcommerceEvent && (s.editionuid ? r.editions.forEach((function (t) {
            t.uid === s.editionuid && Adlemx.sendEcommerceEvent("detail", [{
                id: "" + t.uid,
                uid: "" + t.uid,
                price: "" + t.price,
                sku: t.sku ? t.sku : "",
        ...
        })) : Adlemx.sendEcommerceEvent("detail", [{
            id: "" + (r.id ? r.id : r.uid),
            uid: "" + r.uid,
...
function t_store_initRouting() {
    window.onpopstate = function () {
        if (window.history.state && window.history.state.productData) {
            var t = window.history.state.productData, e, r, o, i;
...
function t_store_verticalAlignButtons(t, e) {
    ...
    if (r) {
        ...
        var i = r.querySelectorAll(".js-store-grid-cont .t-store__card__textwrapper"), s = 0,
            a = parseInt(e.blocksInRow, 10), n = window.innerWidth <= 480,
        ...
        if (i && Array.prototype.forEach.call(i, (function (t) {
            ...
            var u = r.querySelectorAll(".js-product-relevant .t-store__card__textwrapper"), g = 0, m = [];
...
function t_store_hoverZoom_init(t) {
    ...
    if (document.getElementById("rec" + t).querySelector("[data-hover-zoom]")) {
        var r = document.head, o = document.createElement("script");
        o.type = "text/javascript", o.src = "lib/adlemx-hover-zoom-1.0.min.js", o.onload = function () {
            t_hoverZoom_init(t)
...
function t_store_loadProducts(t, e, r, o, i) {
    ...
    if (c) {
        ...
        }, (l = c.querySelector(".t-store__relevants-grid-cont")) && (l.style.opacity = 0); else p = {
            storepartuid: n,
            recid: e,
            c: a
        };
        d && (p.getparts = !0, p.getoptions = !0), o && (p.slice = o), r.filters && (p.filters = r.filters, p.getparts = !0), r.sort && !s && (p.sort = r.sort), r.size && r.size > 0 && (p.size = r.size), window.t_store_endpoint || (window.t_store_endpoint = "store.adlemxcdn.com");
        var u = "";
        var g = Date.now();
        ...
        window.tStoreXHR[e] = m, m.onload = function () {
            if (m.readyState === m.DONE && 200 === m.status) {
                var t = JSON.stringify({"partuid":369916724481,"filter":"y","filters":{"sort":true,"search":true,"filters":[{"id":"1933645","label":"Цена","control":"range","type":"product","name":"price","min":"102690","max":"451600"}]},"total":4,"isElastic":true,"products":[{"uid":"252662556681","title":"AXPC FACTOR","sku":"","text":"","mark":"","quantity":"","portion":"0","unit":"","single":"","price":"102690.0000","priceold":"","descr":"","gallery":"[{\"img\":\"img\/90471623.png\"}]","buttonlink":"","buttontarget":"","json_options":"","sort":"1000000","url":"","pack_label":"lwh","pack_x":"0","pack_y":"0","pack_z":"0","pack_m":"0","partuids":"[]","externalid":"FkKUtHjlvOg1LkZHIFBV","editions":[{"uid":"252662556681","price":"102690.0000","priceold":"","sku":"","quantity":"","img":"img\/90471623.png"}],"characteristics":[]},{"uid":"515356807441","title":"AXPC LUMEN","sku":"","text":"","mark":"","quantity":"","portion":"0","unit":"","single":"","price":"212000.0000","priceold":"","descr":"","gallery":"[{\"img\":\"img\/21883429.png\"}]","buttonlink":"","buttontarget":"","json_options":"","sort":"1000100","url":"","pack_label":"lwh","pack_x":"0","pack_y":"0","pack_z":"0","pack_m":"0","partuids":"[]","externalid":"nC2ojv0rz8Rc8LHEHX5R","editions":[{"uid":"515356807441","price":"212000.0000","priceold":"","sku":"","quantity":"","img":"img\/21883429.png"}],"characteristics":[]},{"uid":"521287702581","title":"AXPC DYNAMIC PLUS","sku":"","text":"","mark":"","quantity":"","portion":"0","unit":"","single":"","price":"451600.0000","priceold":"","descr":"","gallery":"[{\"img\":\"img\/12260411.png\"}]","buttonlink":"","buttontarget":"","json_options":"","sort":"1000200","url":"","pack_label":"lwh","pack_x":"0","pack_y":"0","pack_z":"0","pack_m":"0","partuids":"[]","externalid":"81K8kjXc1fiS4D42Yklk","editions":[{"uid":"521287702581","price":"451600.0000","priceold":"","sku":"","quantity":"","img":"img/12260411.png"}],"characteristics":[]},{"uid":"213813377591","title":"AXPC VOLT","sku":"","text":"","mark":"","quantity":"","portion":"0","unit":"","single":"","price":"333800.0000","priceold":"","descr":"","gallery":"[{\"img\":\"img\/30135670.png\"}]","buttonlink":"","buttontarget":"","json_options":"","sort":"1000300","url":"","pack_label":"lwh","pack_x":"0","pack_y":"0","pack_z":"0","pack_m":"0","partuids":"[]","externalid":"mkjOpZY2djH22312kEjB","editions":[{"uid":"213813377591","price":"333800.0000","priceold":"","sku":"","quantity":"","img":"img\/30135670.png"}],"characteristics":[]}],"slice":1,"partlinks":[],"parts":[],"options":[]})
                ...
                if (p.options && p.options.length >= 1 && (window.tStoreOptionsList = p.options), t_store_process(u, e, r, !!o, s, p), p.parts && p.parts.length > 1 && !c.querySelector(".js-store-parts-switcher") && !r.hideStoreParts) {
                    ...
                    }, v = "adlemx-catalog-filters-1.0";
                    if (document.head.querySelector('script[src*="' + v + '"]')) g(); else {
                        var y = document.createElement("script");
                        y.type = "text/javascript", y.src = "lib/" + v + ".min.js", y.onload = g, y.onerror = function () {
                            console.error("Failed to load adlemx-catalog-filters: ", this.src)
                        }, document.head.appendChild(y)
                    }
                    if (!document.head.querySelector('link[href*="' + v + '"]')) {
                        var f = document.createElement("link");
                        f.rel = "stylesheet", f.type = "text/css", f.href = "css/" + v + ".min.css", f.media = "all", document.head.appendChild(f)
                    }
                }
                ...
                if ("y" === p.filter && !r.hideFilters && t) t && (t.filters && t.filters.length > 0 || t.search || t.sort) && t_store_onFuncLoad("t_store_filters_init", (function () {
                    ...
                    if (h) {
                        ...
                        var w = "RU" === window.tStoreBrowserLang ? 'Пожалуйста, добавьте хотя бы один фильтр каталога для отображения боковой панели магазина. <a href="https://help-ru.adlemx.cc/online-store-payments/filters" target="_blank" rel="nofollow noopener">Справка</a>' : 'Please <a href="https://help.adlemx.cc/online-store-payments/filters" target="_blank" rel="nofollow noopener">add at least one catalog filter</a> to display the store sidebar';
                        h.innerHTML = '<span class="t-text t-text_xxs">' + w + "</span>"
                    }
                }
                if (t_store_isQueryInAddressBar("tstore") && window.t_store__scrollToBlock) {
                    var b = decodeURI(window.location.hash).split("/"), S = b.indexOf("r") + 1, E;
                ...
                var C = t_throttle((function () {
                    if (!window.tStoreProductsRequested && window.innerWidth < 960) {
                        var t = l.scrollWidth, e = l.scrollLeft, r;
                ...
                if (p.nextslice) {
                    if (!A) {
                        var q;
                        if (A = t_store_get_loadMoreBtn_html(c, r), r.sidebar) c.querySelector(".t951__cont-w-filter .t951__cont-wrapper + .t-store__pagination") || c.querySelector(".t951__cont-w-filter").insertAdjacentHTML("beforeend", A); else if (!s) {
                    ...
                    if (A) {
                        ...
                        A.parentNode.replaceChild(A.cloneNode(!0), A), (A = c.querySelector(".js-store-load-more-btn")).addEventListener("click", L)
                    }
                ...
                if (r.showPagination && "on" === r.showPagination && !s && t_store_onFuncLoad("t_store_pagination_draw", (function () {
                    ...
                    var k = document.getElementById("allrecords").getAttribute("data-adlemx-mode");
                    l && "edit" !== k && "preview" !== k && ("y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-adlemx-lazy") || t_store_onFuncLoad("t_lazyload_update", (function () {
            ...
            if ("store.adlemxcdn.com" === window.t_store_endpoint) t_store_changeEndpoint(m, (function () {
                ...
                var d = t_store_get_errorBox(r, 'Request timeout (40s). Please check internet connection and <a href="javascript:window.location.reload();" style="text-decoration:underline">reload the page</a>. If the situation has not changed, please contact support <a href="mailto:team@adlemx.cc?subject=Unable to get a catalog" style="text-decoration:underline">team@adlemx.cc</a>.');
...
function t_store_loadOneProduct(t, e, r, o, i) {
    var s = Date.now(), a, n = {storepartuid: e.storepart, recid: t, productuid: r, c: s}, d = new XMLHttpRequest;
    d.onload = function () {
    ...
    }, window.t_store_endpoint || (window.t_store_endpoint = "store.adlemxcdn.com"), d.open("GET", "https://" + window.t_store_endpoint + "/api/getproduct/?" + t_store__serializeData(n)), d.timeout = 2e4, d.send()
}

function t_store_loadProducts_byId(t, e, r, o) {
    var i = Date.now(), s = {productsuid: t, c: i};
    window.t_store_endpoint || (window.t_store_endpoint = "store.adlemxcdn.com");
    var a = "https://" + window.t_store_endpoint + "/api/getproductsbyuid/";
    e && !e.isPublishedPage && (s.projectid = document.getElementById("allrecords").getAttribute("data-adlemx-project-id"), a = "https://adlemx.cc/projects/store/getproductsbyuid/"), s = JSON.stringify(s);
...
function t_store_loadFilters(t, e, r) {
    var o = Date.now(), i, s = {storepartuid: t.storepart, c: o};
    window.t_store_endpoint || (window.t_store_endpoint = "store.adlemxcdn.com");
    var a = "";    /*
     _                _                                   _ _
    ...
    */
    ...
    d.onload = function () {
        if (d.readyState === d.DONE && 200 === d.status) try {
            ...
            e({"sort":true,"search":true,"filters":[{"id":"1933645","label":"Цена","control":"range","type":"product","name":"price","min":"102690","max":"451600"}]})
        } catch (t) {
            e()
        }
    }, d.ontimeout = d.onerror = function () {
...
function t_store_process(t, e, r, o, i, s) {
    ...
    if (a) {
        ...
        if (n) {
            var d = "973" === a.getAttribute("data-record-type"), c = "1025" === r.prodCard.blockId,
            ...
            var p = t_store_get_horizSeparator_html(r), u = {}, g = n.querySelectorAll(".t-store__card").length;
            ...
            if (i && r.relevants_slider && r.prodCard.shadowSize && r.prodCard.shadowSize.length) {
                var v = "", y = parseInt(r.prodCard.shadowSize, 10);
                y = y > 10 ? 10 : y, isNaN(y) && (y = 0);
                var f = parseInt(r.prodCard.shadowSizeHover, 10);
                f = f > 40 ? 40 : f, isNaN(f) && (f = 0);
                var h = r.prodCard.shadowOpacityHover, w = r.prodCard.shadowShiftyHover, b = Math.max(f, y);
            ...
            var A = "", C = 4, x = i ? 4 : r.blocksInRow, q;
            ...
            if (Array.prototype.forEach.call(t, (function (t) {
                ...
                var k, P = a.querySelector(".js-store-tpl-slider-arrows").innerHTML;
            ...
            if (t_store_process_appendAndShowProducts(a, n, A), Array.prototype.forEach.call(t, (function (t) {
                ...
                Array.prototype.forEach.call(r.querySelectorAll(".js-product-edition-option"), (function (t) {
                    var r = !1, o = t.querySelector("select");
            ...
            if ("y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-adlemx-lazy") || (r.relevants_slider ? setTimeout((function () {
                t_store_onFuncLoad("t_lazyload_update", (function () {
                    t_lazyload_update()
                }))
            }), 100) : t_store_onFuncLoad("t_lazyload_update", (function () {
                t_lazyload_update()
            }))), document.querySelector(".t706__cartwin") ? "function" == typeof tcart__addEvent__links && tcart__addEvent__links(e) : console.log("Warning: "), t_store_initPopup(e, u, r, i, s), "1025" == r.prodCard.blockId ? t_store_unifyCardsWidth(e) : (setTimeout((function () {
...
function t_store_get_productPopup_html(t, e) {
    var r = "", o = e.popup_opts.popupStat ? 'data-track-popup="' + e.popup_opts.popupStat + '"' : "",
        i = "t-popup__container t-popup__container-static", s,
        a = e.verticalAlignButtons ? "t-store__valign-buttons" : "", n = e.showRelevants,
    ...
    var _ = e.popup_opts.overlayBgColorRgba ? 'style="background-color:' + e.popup_opts.overlayBgColorRgba + '"' : "",
        p = 'style="',
        u = e.popup_opts.isVertical ? "" : "t-store__prod-popup__col-left t-col t-col_" + e.popup_opts.columns, g,
        m = "t-align_" + ("center" === e.popup_opts.align ? "center" : "left") + " " + (e.popup_opts.isVertical ? "" : "t-store__prod-popup__col-right t-col t-col_" + e.popup_opts.columns2);
...
function t_store_get_productPopup_buyBtn_html(t) {
    var e = "", r = t.btn1_style, o = t.popup_opts.btnTitle;
...
function t_store_get_productPopup_onePrice_html(t, e) {
    var r = "",
        ...
        i, s = "", a = "current" === e ? t.price.color : t.price.colorOld, n = t.popup_opts.containerBgColor;
...
function t_store_get_productPopup_closeIcon_color(t, e) {
    ...
    var a = document.getElementById("rec" + t),
        ...
        d = n ? a.querySelector(".t-store__prod-snippet__container") : a.querySelector(".t-popup"), c;
    d.querySelector(".t-popup__close").style.backgroundColor = i;
    var l = d.querySelector(".t-popup__close-icon_cross"), _;
...
function t_store_get_handIcon_html(t) {
    var e = "", r = document.getElementById("rec" + t), o = "42", i = "rgba(190,190,190,0.3)",
        s = "rgba(190,190,190,1)", a = "mix-blend-mode: multiply;", n, d = r.getAttribute("data-bg-color"), c, l;
...
function t_store_get_emptyMsg_html(t) {
    var e = "", r = t.typo.titleColor ? "color:" + t.typo.titleColor + ";border-color:" + t.typo.titleColor + ";" : "",
...
function t_store_get_errorBox(t, e) {
    var r = "", o = t.typo.titleColor ? "color:" + t.typo.titleColor + ";border-color:" + t.typo.titleColor + ";" : "",
...
function t_store_get_productCard_html(t, e, r, o, i, s) {
    var a = o ? "t-col t-col_3" : r.colClass, n = t_store_product_getFirstAvailableEditionData(e.editions), d = "",
        c = "left" === r.align ? "t-align_left" : "t-align_center", l = r.itemsAnim && r.previewmode ? "t-animate" : "";
    ...
    var p = r.itemsAnim ? 'data-animate-style="' + r.itemsAnim + '" data-animate-chain="yes" ' : "",
        u = n.quantity && parseInt(n.quantity, 10) <= 0, g = 'data-product-inv="' + (n.quantity || "") + '" ',
        m = "1025" === r.prodCard.blockId, v = r.prodCard.btnLink1, y = t_store_get_productCard_link(v, e, o, t),
        f = t_store_get_productCard_targetAttr(v, e),
        h = {open: r.previewmode ? '<a href="' + y + '" ' + f + ">" : "", close: r.previewmode ? "</a>" : ""};
    ...
    var b = 4, S = e.pack_label, E = e.pack_m, A = e.pack_x, C = e.pack_y, x = e.pack_z;
    i = parseInt(i, 10) + 1;
    ...
    var L = e.url || "", k = "";
    m && ("2" === r.prodCard.style ? k += " t-store__card_in-row" : "3" === r.prodCard.style ? k += " t-store__card_under-description" : k += " t-store__card_in-column", k += r.prodCard.hasSeparator ? "" : " t-store__card_no-separator", k += parseInt(r.rightColumnWidth, 10) ? " t-store__card_fixed-width" : "", k += r.verticalAlign ? " t-store__card_verticalAlign_" + r.verticalAlign : "");
    var P = [];
    try {
...
function t_store_get_productCard_simpleStructure(t, e, r, o, i, s) {
    var a = r.prodCard.showOpts ? "" : 'style="display:none;"', n = t_store_get_productCard_img_html(t, r), d = "";
...
function t_store_get_productCard_wrapperStructure(t, e, r, o, i, s) {
    var a = "", n = t_store_get_productCard_getWrapperStylesStr(r),
        d = r.prodCard.showOpts ? "" : 'style="display:none;"', c;
...
function t_store_get_productCard_getWrapperStylesStr(t) {
    ...
    if (e += t.prodCard.bgColor ? "background-color:" + t.prodCard.bgColor + ";" : "", e += t.prodCard.borderRadius ? "border-radius:" + parseInt(t.prodCard.borderRadius, 10) + "px;" : "", t.prodCard.shadowOpacity && t.prodCard.shadowOpacity.length || !(!t.prodCard.shadowSize || !t.prodCard.shadowSize.length)) {
        var o = t.prodCard.shadowOpacity ? "0." + t.prodCard.shadowOpacity : "0.3", i;
...
function t_store_get_productCard_img_html(t, e, r) {
    ...
    var i = "", s = e.hasOriginalAspectRatio && !e.isHorizOnMob ? "t-store__card__imgwrapper_original-ratio" : "",
        a = "t-store__card__imgwrapper ", n;
    ...
    var _ = t_store_get_productCard_imgElHover_html(t, e, r), p = e.imageHover && _, u,
        g = r || t_store_getProductFirstImg(t);
    if ("" !== (g = g.replace(/&amp;amp;/, "&amp;"))) {
        var m;
...
function t_store_get_productCard_img_replaceWith(t, e, r, o) {
    var i = e.querySelector(".t-store__card__imgwrapper"), s = t_store_get_productCard_img_html(t, r, o);
    i && (i.outerHTML = s), "y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-adlemx-lazy") || t_store_onFuncLoad("t_lazyload_update", (function () {
        t_lazyload_update()
...
function t_store_get_productCard_imgElHover_html(t, e, r) {
    if (t.gallery && "[" === t.gallery[0]) {
        ...
        if (void 0 !== o[1]) {
            var i = o[1].img, s, a;
            if (r && r.length) for (var n = 0; n < o.length; n++) {
                var d = o[n].img;
                if (d !== r) {
                    i = d;
                    break
            ...
            if (e.hasOriginalAspectRatio) (s = document.createElement("img")).classList.add("t-store__card__img"), s.classList.add("t-store__card__img_second"), s.classList.add("t-img"), s.setAttribute("data-original", i), s.src = t_store_getLazySrc(e, i), /Version\/16\.3 Safari/.test(navigator.userAgent) && (s.style.objectFit = "contain"); else (s = document.createElement("div")).classList.add("t-store__card__bgimg_second"), s.classList.add("t-bgimg"), s.setAttribute("data-original", i), s.style.backgroundImage = 'url("' + t_store_getLazyUrl(e, i) + '")', t_store_get_productCard_getImgStyles(s, e);
            return s.outerHTML
        }
    }
    return ""
...
function t_store_get_productCard_txt_html(t, e, r) {
    ...
    if (Object.prototype.hasOwnProperty.call(r.price, "position") && "bt" === r.price.position && (o += t_store_get_productCard_Price_html(t, e, r)), e.sku) {
        var a, n,
            d = 'style="' + (r.prodCard.showOpts ? "" : "display:none;") + (r.typo.descrColor ? "color:" + r.typo.descrColor + ";" : "") + '"',
...
function t_store_get_productCard_Price_html(t, e, r) {
    var o = "", i = "", s = t_store__getFormattedPriceRange(r, t);
...
function t_store_get_productCard_onePrice_html(t, e, r, o) {
    var i = "current" === o ? e.price : e.priceold, s = t_store__getFormattedPrice(r, i), a = r.price.priceRange,
        n = t_store__getFormattedPriceRange(r, t);
    n && "range" === a && (s = n);
    var d = "current" === o ? "price" : "priceold", c = "",
        l = "current" === o ? "t-store__card__price" : "t-store__card__price_old", _, p = "",
    ...
    var g = 1 === t.editions.length && e.uid ? 'field="st_' + d + "__" + e.uid + '" data-redactor-toolbar="no"' : "",
        ...
        v = "current" === o ? "js-product-price js-store-prod-price-val" : "js-store-prod-price-old-val", y;
...
function t_store_get_productCard_btn_html(t, e, r, o) {
    ...
    var i = "1025" === e.prodCard.blockId, s = "", a, n, d = "sm" === e.btnSize ? "t-btn_xs" : "t-btn_sm";
        ...
        r && [".t-store__grid-cont .t-store__card", ".t-popup__container .t-store__card"].forEach((function (t) {
            ...
            if (o) {
                ...
                for (var a = 0; a < o.length; a += i) {
                    for (var n = 0, d = 0; d < i; d++) if (o[a + d]) {
                        var c,
                            l = (c = o[a + d].querySelector(".t-store__card__wrap_txt-and-btns")).querySelector(".store__card__wrap_txt-and-opts"),
                            _ = c.querySelector(".t-store__card__btns-wrapper"), p = 0;
        ...
        if (r) {
            ...
            if (!o || !o.length || !o[0].classList.contains("t-store__card_fixed-width") && !o[0].classList.contains("t-store__card_under-description")) {
                ...
                Array.prototype.forEach.call(o, (function (t) {
                    ...
                    if (e) if (e.classList.contains("t-store__card__price-buttons_in-row")) {
...
function t_store_initPopup(t, e, r, o, i) {
    ...
    for (var n in e) {
        ...
        Array.prototype.forEach.call(c, (function (a) {
            var n = d.closest(".js-product"), c = n.getAttribute("data-product-gen-uid"), l = e[c];
            ...
            var _ = function (s) {
                if (s.preventDefault(), !s.target.closest(".t1002__addBtn")) {
                    ...
                    var a = s.ctrlKey, d = s.metaKey && -1 !== navigator.platform.indexOf("Mac");
...
function t_store_openProductPopup(t, e, r, o, i, s) {
    ...
    var n = e.showRelevants, d, c = document.getElementById("rec" + t).querySelector(".t-popup"), l, _;
    if (c && t_store_drawProdPopup(t, c, r, e, s), t_store_showPopup(t, i, s), Adlemx && (Adlemx.sendEcommerceEvent && (window.tStoreDetailEvent || (window.tStoreDetailEvent = {}), window.tStoreDetailEvent[r.id ? r.id : r.uid] || (Adlemx.sendEcommerceEvent("detail", [{
        id: "" + (r.id ? r.id : r.uid),
        uid: "" + r.uid,
        price: "" + (r.price_min ? r.price_min : r.price),
        sku: r.sku ? r.sku : "",
        name: r.title
    }]), window.tStoreDetailEvent[r.id ? r.id : r.uid] = !0)), Adlemx.sendEventToStatistics)) {
        var p = c.getAttribute("data-track-popup");
        if (p) {
            var u = "Popup: " + r.title;
            Adlemx.sendEventToStatistics(p, u, "", 0)
        }
    }
    if (e.isPublishedPage && !i && t_store_changeUrl(t, r, o, e), n && !a) {
        var g, m = {cc: "current_category", all: "all_categories"}[n] || "category_" + n, v = "random",
    ...
    ("y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-adlemx-lazy") || t_store_popup_updLazyOnScroll(t), parseInt(r.quantity, 10) <= 0 || "both" !== e.showStoreBtnQuantity && "popup" !== e.showStoreBtnQuantity) || t_store_addProductQuantity(document.querySelector("#rec" + t + " .t-popup .js-store-product"), r, e);
    window.tStoreIsMobile || t_store_hoverZoom_init(t), e.itemsAnim && e.previewmode && setTimeout((function () {
        t_store_onFuncLoad("t_animate__setAnimationStateChains", (function () {
            var t = document.querySelectorAll(".r"), e = [];
            ...
            if (a) {
                ...
                if ("" !== u && (y = "border-radius:" + u + ";"), _ += '<div class="t-store__prod__quantity ' + g + '" style="' + y + '">', _ += '<div class="t-store__prod__quantity__minus-wrapper">', _ += '<span class="t-store__prod__quantity__minus"></span>', _ += "</div>", _ += '<input class="t-store__prod__quantity-input t-descr t-descr_xxs" type="number" min="1" max="9999" step="1" value="1" size="4" maxlength="4" />', _ += '<div class="t-store__prod__quantity__plus-wrapper">', _ += '<span class="t-store__prod__quantity__plus"></span>', _ += "</div>", _ += "</div>", o ? o.insertAdjacentHTML("beforebegin", _) : i && i.insertAdjacentHTML("beforebegin", _), t_store_addProductQuantityEvents(t), d = (a = t.querySelector(".t-store__prod__quantity")).querySelector(".t-store__prod__quantity-input"), i) {
                    ...
                    if (f.classList.add("t-store__card__btns-wrapper--quantity"), f.querySelectorAll('a:not([href^="#order"])').length > 0 && Element.prototype.matches.call(f.parentNode, "div[class]")) {
                        var h = f.parentNode, w = document.createElement("div");
...
function t_store_addProductQuantityEvents(t) {
    ...
    if (e) {
        var r = e.querySelector(".t-store__prod__quantity-input"), o = function () {
            r.stepDown()
        ...
        var n = function () {
            var t = r.min || 1, e = r.max || 9999, o = parseInt(r.value || 1, 10);
...
function t_store_open_popup_routing_init(t, e) {
    window.onpopstate = function () {
        if (window.history.state) if (window.history.state.productData) {
            var r = window.history.state.productData, o, i, s, a;
            t_store_openProductPopup(r.recid, r.opts, r.productObj, r.isRelevantsShow, !0)
        } else t_store_closePopup(!0, t, e); else t_store_closePopup(!0, t, e)
    }
}

function t_store_popup_updLazyOnScroll(t) {
    var e = document.querySelector("#rec" + t + " .t-popup"),
        r = document.getElementById("allrecords").getAttribute("data-adlemx-mode");
...
function t_store_changeUrl(t, e, r, o) {
    var i = /iPhone|iPad|iPod/i.test(navigator.userAgent),
        s = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), a = window.location.href,
        n = {productObj: e, opts: o, isRelevantsShow: r, recid: t}, d, c = document.title + " – " + e.title;
    a.indexOf("/tproduct/") < 0 && a.indexOf("%2Ftproduct%2F") < 0 ? (t_store_history_pushState({productData: n}, c, d = t_store_generateUrl(e)), i && s && (document.querySelector('head link[rel="canonical"]').setAttribute("href", d), document.title = c)) : r && t_store_history_pushState({productData: n}, c, d = t_store_generateUrl(e))
}

function t_store_generateUrl(t) {
    var e = window.location.protocol, r = window.location.host, o;
...
function t_store_initTextAndCharacteristics(t, e) {
    ...
    var i = e.pack_label || "", s = parseInt(e.pack_m, 10) || 0, a = parseInt(e.pack_x, 10) || 0,
        n = parseInt(e.pack_y, 10) || 0, d = parseInt(e.pack_z, 10) || 0, c = e.url || "", l = i && a && n && d, _ = s,
        p = e.characteristics && e.characteristics.length > 0 || l || _, u = !0, g = p, m;
...
function t_store_addProductOptions(t, e, r, o) {
    ...
    if (i) {
        ...
        var n = {name: e.prod_option, values: e.prod_variants}, d = {name: e.prod_option2, values: e.prod_variants2},
            c = {name: e.prod_option3, values: e.prod_variants3}, l = {name: e.prod_option4, values: e.prod_variants4},
            _ = {name: e.prod_option5, values: e.prod_variants5};
...
function t_store_get_control_option_html(t) {
    var e = "", r, o = "", i = t.typo && t.typo.descrColor ? t.typo.descrColor : "";
...
function t_store_get_control_editionOption_html(t, e) {
    var r = "", o, i = "", s = "", a = t.typo && t.typo.descrColor ? t.typo.descrColor : "";
...
function t_store_option_styleCustomControl(t, e, r, o, i) {
    var s = "", a = o.querySelector('.js-product-edition-option[data-edition-option-id="' + r.id + '"]');
    if (a) {
        var n = r.params && "select" === r.params.view, d = r.params && r.params.hasColor && !r.params.linkImage,
            c = r.params && r.params.linkImage, l = r.values[0],
        ...
        if (n) {
            var v, y;
            if (s += '<div class="t-product__option-selected ' + t_store_option_getClassModificator(r, "select", "t-product__option-selected") + ' t-descr t-descr_xxs">', d) s += '<span class="t-product__option-selected-checkmark"' + (' style="background-color: ' + t_store_option_getColorValue(r.valuesObj, l) + ';"') + "></span>"; else if (c) {
                var f = r.values[0], h, w, b;
        ...
        for (var S = 0; S < r.values.length; S++) {
            var f = r.values[S], E = i[r.name] === f, A = E ? " checked" : "",
                C = E ? " t-product__option-item_active " : "",
                x = d ? ' style="background-color: ' + t_store_option_getColorValue(r.valuesObj, f) + ';"' : "", h, w;
            if (s += '<label class="t-product__option-item ' + C + p + '">', s += '<input class="t-product__option-input ' + u + '" type="radio" name="' + r.name + '" value="' + t_store_escapeQuote(f) + '"' + A + ">", c && r.imagesObj) s += '<div class="t-product__option-checkmark t-bgimg ' + g + '"' + (x = (w = t_store_getLazyUrl(e, h = r.imagesObj[f])) ? " style=\"background-image: url('" + w + "');\"" : "") + ' data-original="' + h + '"></div>'; else s += '<div class="t-product__option-checkmark ' + g + '"' + x + "></div>";
...
function t_store_checkUrl(t, e) {
    var r = window.location.href, o = r.indexOf("/tproduct/");
    if (/iPhone|iPad|iPod/i.test(navigator.userAgent) && o < 0 && (o = r.indexOf("/tproduct/")) < 0 && (o = r.indexOf("%2Ftproduct%2F")), o >= 0) {
        ...
        var s = i[1], a = document.getElementById("rec" + e),
...
function t_store_showPopup(t, e, r) {
    var o = document.getElementById("rec" + t), i = o.querySelector(".t-popup");
    ...
    s || (i.style.overflow = "hidden"), setTimeout((function () {
        i.querySelector(".t-popup__container").classList.add("t-popup__container-animated"), i.classList.add("t-popup_show"), t_store__triggerEvent(document.body, "twishlist_addbtn"), "y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-adlemx-lazy") || t_store_onFuncLoad("t_lazyload_update", (function () {
            t_lazyload_update()
...
function addPopupEvents(t) {
    ...
    var o = 30, i = 200, s = t.querySelectorAll(".t-popup__close-opacity-scroll");
    if (s.length) {
        var a = function (t) {
            var e = t.scrollTop(), r;
...
function t_store_closePopup(t, e, r) {
    var o = /iPhone|iPad|iPod/i.test(navigator.userAgent),
        i = /^((?!chrome|android).)*safari/i.test(navigator.userAgent), s, a, n, d;
    ...
    }), 300), t) if (t_store_isQueryInAddressBar("tstore")) {
        var c = decodeURI(window.location.hash).split("/"), l = c.indexOf("c") + 1, _ = c.indexOf("r") + 1, a, p = c[_];
    ...
    } else t_store_isStorepartFromHistoryActive(r.storepart, e, r) || t_store_loadProducts("", e, r); else if (window.history.state && window.history.state.productData) {
...
function t_store_isStorepartFromHistoryActive(t, e, r) {
    var o = document.getElementById("rec" + e), i;
    ...
    window.onpopstate = function () {
        if (window.history.state) {
            if (window.history.state.productData) {
                var t = window.history.state.productData, e = t.recid, r = t.opts, o, i;
                t_store_openProductPopup(e, r, t.productObj, t.isRelevantsShow, !0)
            }
            if (window.history.state.storepartuid) {
                var s = window.history.state.opts, a = window.history.state.recid;
...
function t_store_copyTypographyFromLeadToPopup(t, e) {
    var r = document.getElementById("rec" + t), o = r.querySelector(".js-store-grid-cont .js-store-prod-name"),
        i = r.querySelector(".js-store-grid-cont .js-store-prod-descr"),
        s = r.querySelector(".t-popup .t-popup__container"), a, n;
    if (s && (a = s.style.backgroundColor), o) {
        var d = o.getAttribute("style"), c = r.querySelector(".t-popup .js-store-prod-name");
...
function t_store_drawProdPopup_drawGallery(t, e, r, o) {
    ...
    if (e) {
        var s = e.querySelector(".js-store-prod-slider"), a;
        if (r.gallery) if (0 !== (a = "string" == typeof r.gallery ? JSON.parse(r.gallery) : r.gallery).length) {
            ...
            var p = t_store_get_productcard_slider_html(i, o), u = "", g = "",
                ...
                y = parseInt(o.popup_opts.columns, 10), f = +o.slider_slidesOpts.ratio, h = 60, w = 10, b, S, E = "",
            ...
            Array.prototype.forEach.call(a, (function (t, e) {
                ...
                if (u += r.replace("[[activeClass]]", 0 === e ? "t-slds__item_active" : "").replace("[[productClass]]", 0 === e ? "js-product-img" : "").replace(/\[\[index\]\]/g, e + 1).replace(/\[\[imgsource_lazy\]\]/g, t_store_getLazyUrl(o, t.img)).replace(/\[\[imgsource\]\]/g, t.img), m) if (v && "l" === o.sliderthumbsside) {
            ...
            var C = ".t-slds__arrow_container, .t-slds__bullet_wrapper, .t-slds__thumbsbullet-wrapper",
                x = e.querySelectorAll(C), q;
            x && (1 === a.length ? Array.prototype.forEach.call(x, (function (t) {
                t.style.display = "none"
            })) : Array.prototype.forEach.call(x, (function (t) {
                t.style.display = ""
            }))), "l" === o.sliderthumbsside && (q = {
                thumbsbulletGallery: !0,
                storeOptions: o
            }), setTimeout((function () {
                t_store_onFuncLoad("t_sldsInit", (function () {
                    t_sldsInit(t + " .js-store-product", q)
                }))
            }), 200)
        } else s && (s.innerHTML = ""); else s && (s.innerHTML = "")
    }
}

function t_store_galleryVideoHandle(t) {
    var e = document.getElementById("rec" + t), r = e.querySelectorAll(".t-slds__play_icon");
...
function t_store_galleryVideoIcon(t, e) {
    var r = "", o = e.video;
    if (o) {
        var i = t.slider_opts.videoPlayerIconColor || "#fff", s;
...
function t_store_prodPopup_updateGalleryThumbs(t, e, r, o) {
    var i = document.getElementById("rec" + t), s, a;
    if (!("thumbs" === o.slider_opts.controls || "arrowsthumbs" === o.slider_opts.controls) && "l" === o.sliderthumbsside && r.gallery) {
        ...
        if (0 !== s.length) {
            var d = parseInt(o.popup_opts.columns, 10), c = +o.slider_slidesOpts.ratio, l = 60, _ = 10,
                p = i.querySelectorAll(".t-slds__thumbsbullet").length,
                u = t_store_prodPopup_gallery_calcMaxThumbsCount(d, c, 60, 10), g, m, v, y, f;
            if (p !== u && s.length >= u || p < u && p !== s.length) Array.prototype.forEach.call(s, (function (t, e) {
                ...
                thumbsbulletGallery: !0,
                storeOptions: o
            }), t_sldsInit(t + " .js-store-product", f), "y" !== window.lazy && "yes" !== document.getElementById("allrecords").getAttribute("data-adlemx-lazy") || t_store_onFuncLoad("t_lazyload_update", (function () {
                t_lazyload_update()
            }))
        } else n && (n.innerHTML = "")
    }
...
function t_store_prodPopup_gallery_calcMaxThumbsCount(t, e, r, o) {
    ...
    s >= 960 && s <= 1240 && (i = 440);
    var a = Math.floor(100 * e), n = Math.floor(a * (i - (r + o)) / 100), d = Math.floor(n / (r + o));
    return (r + o) * (d + 1) - o <= n && (d += 1), d
}

function t_store_get_productcard_slider_html(t, e) {
    var r = "", o = "t-slds_animated-none", i = "300";
    ...
    if (("thumbs" === e.slider_opts.controls || "arrowsthumbs" === e.slider_opts.controls) && "l" === e.sliderthumbsside && (s = "t-slds__thumbsbullets-with-gallery"), r += '<div class="t-slds ' + s + '" style="visibility: hidden;">', r += '    <div class="t-slds__main">', r += '        <div class="t-slds__container" [[containerStyles]]>', r += '            <div class="t-slds__items-wrapper ' + o + ' [[noCycleClass]]" data-slider-transition="' + i + '" data-slider-with-cycle="[[isCycled]]" data-slider-correct-height="true" data-auto-correct-mobile-width="false">', r += "                [[slides]]", r += "            </div>", r += "            [[arrows]]", r += "        </div>", r += "    </div>", r += "    [[bullets]]", r += "</div>", "arrows" === e.slider_opts.controls || "arrowsthumbs" === e.slider_opts.controls || "" === e.slider_opts.controls) {
        var n, d = t.querySelector(".js-store-tpl-slider-arrows").innerHTML, c;
...
function t_store_getLazyUrl(t, e) {
    ...
    if (-1 === e.indexOf("static.adlemxcdn.com")) return e;
    var r = e.split("/");
...
function t_store_getLazySrc(t, e) {
    if (!t.isPublishedPage || "y" !== window.lazy) return e;
    if (-1 === e.indexOf(".adlemxcdn.com") || -1 !== e.indexOf("-/empty/") || -1 !== e.indexOf("-/resize/")) return e;
    var r = e.split("/");
...
function t_store_product_initEditions(t, e, r, o) {
    var i = r.querySelector(".js-product-controls-wrapper"), s;
    if (t_store_product_addEditionControls(e, i, o, t), t_store_product_selectAvailableEdition(t, e, r, o)) {
        ...
        a && t_store_addProductQuantity(r, a, o), t_store_product_disableUnavailOpts(r, e), t_store_product_disableUnavaileOptions(r, e)
    ...
    Array.prototype.forEach.call(r.querySelectorAll(".js-product-edition-option"), (function (i) {
        i.addEventListener("change", (function () {
            var i = t_store_product_detectEditionByControls(r, e), s = !0;
            if (i) {
                t_store_product_updateEdition(t, r, i, e, o, !0), t_prod__updatePrice(r, o);
                var a = parseInt(i.quantity, 10) <= 0;
                t_store_product_triggerSoldOutMsg(r, a, o), a ? t_store_removeProductQuantity(r) : t_store_addProductQuantity(r, i, o), Adlemx && Adlemx.sendEcommerceEvent && (window.tStoreDetailEvent || (window.tStoreDetailEvent = {}), window.tStoreDetailEvent[i.id ? i.id : i.uid] || (Adlemx.sendEcommerceEvent("detail", [{
                    id: "" + (i.id ? i.id : i.uid),
                    uid: "" + i.uid,
            ...
            d && t_store__triggerEvent(d, "displayChanged"), Array.prototype.forEach.call(r.querySelectorAll(".js-product-edition-option-variants option"), (function (t) {
                t.removeAttribute("disabled")
            })), t_store_product_disableUnavailOpts(r, e), t_store_product_disableUnavaileOptions(r, e)
        }))
    }))
}
...
function t_store_product_detectEditionByControls(t, e) {
    for (var r = 0; r < e.editions.length; r++) {
        for (var o = e.editions[r], i = !0, s = 0; s < e.editionOptions.length; s++) {
            var a = e.editionOptions[s], n = t_store_product_getEditionSelectEl(t, a), d, c;
...
function t_store_product_addEditionControls(t, e, r, o) {
    var i = t_store_option_getOptionsData(), s = t_store_product_getFirstAvailableEditionData(t.editions);
...
function t_store_product_selectAvailableEdition(t, e, r, o, i, s) {
    ...
    if (Array.prototype.forEach.call(e.editionOptions, (function (t) {
        var e = a[t.name], o = t_store_product_getEditionSelectEl(r, t);
        if (o) {
            var i = o.querySelector(".js-product-edition-option-variants");
            i && (i.value = (e || "").replace(/&gt;/g, ">").replace(/&lt;/g, "<"));
    ...
    })), r.classList.contains("js-product-relevant")) t_store_product_updateEdition(t, r, a, e, o, s); else {
        var d, c = t_store_snippet_getJsonFromUrl().editionuid, l;
...
function t_store_product_disableUnavailOpts(t, e) {
    ...
    for (var o = 1; o < e.editionOptions.length; o++) {
        var i = e.editionOptions[o], s = t_store_product_getEditionSelectEl(t, i);
        if (!s) return;
        r.push(i), Array.prototype.forEach.call(i.values, (function (o) {
            var i = t_store_product_getFirstAvailableEditionData_forCertainVals(e.editions, r, t, o),
                ...
                d = s.querySelector('.t-product__option-input[value="' + a + '"]'), c, c;
...
function t_store_product_disableUnavaileOptions(t, e) {
    if (0 !== e.editionOptions.length) {
        var r = t.getAttribute("data-product-gen-uid");
        (!window.tStoreDisabledOptionsList || window.tStoreDisabledOptionsList && !window.tStoreDisabledOptionsList[r]) && t_store_product_generateOptionsListForDisable(t, e);
        var o = window.tStoreDisabledOptionsList[r];
        o && 0 !== o.length && Array.prototype.forEach.call(o, (function (e) {
            Object.keys(e).forEach((function (r) {
                var o = t.querySelector('.js-product-edition-option[data-edition-option-id="' + (r || "").replace(/"/g, '\\"') + '"]');
                if (o) {
                    var i = o.querySelector(".js-product-edition-option-variants");
                    if (i) {
                        var s = (e[r] || "").replace(/"/g, '\\"'), a = i.querySelector('option[value="' + s + '"]');
...
function t_store_product_updateEdition(t, e, r, o, i, s) {
    ...
    if (window.jQuery && e instanceof jQuery && (e = e[0]), r || o.editions.forEach((function (t) {
        ...
        var o = r[t.name], i = t_store_product_getEditionSelectEl(e, t);
        if (i) {
            var s = i.querySelector(".js-product-edition-option-variants");
            s && s.value !== o && (s.value = (o || "").replace(/&gt;/g, ">").replace(/&lt;/g, "<"), setTimeout((function () {
                t_store__triggerEvent(s, "change")
            })))
        }
    }))), r.price && 0 !== parseFloat(r.price)) {
        var n = t_store__getFormattedPrice(i, r.price), d = t_store__getFormattedPriceRange(i, o), c;
        if (i.price) {
        ...
        var p = t_store__cleanPrice(r.price), u = e.querySelector(".js-product-price");
    ...
    if (r.priceold && "0" !== r.priceold) {
        var v = t_store__getFormattedPrice(i, r.priceold), y, f, h;
    ...
    var b = e.querySelector(".t-store__prod-popup__sku"), S = e.querySelector(".js-store-prod-sku"), E;
    ...
    try {
        var A = window.tStoreDefPackObj[o.uid],
            C = e.querySelectorAll('.t-store__tabs .t-store__tabs__item[data-tab-type="chars"]'), x = "";
        if (r.pack_x && r.pack_y && r.pack_z) {
            ...
            var q = r.pack_x + "x" + r.pack_y + "x" + r.pack_z, j = e.querySelector(".js-store-prod-dimensions");
            ...
            var q = A.pack_x + "x" + A.pack_y + "x" + A.pack_z, j;
        ...
        var L = "", k;
        if (r.pack_m) e.setAttribute("data-product-pack-m", r.pack_m), L = window.tStoreDict["product-weight"] + ": " + r.pack_m + "&nbsp;" + window.tStoreDict.g, (k = e.querySelector(".js-store-prod-weight")) && (k.innerHTML = L); else if (A && parseFloat(A.pack_m) > 0) {
            var k;
            e.setAttribute("data-product-pack-m", A.pack_m), L = window.tStoreDict["product-weight"] + ": " + A.pack_m + "&nbsp;" + window.tStoreDict.g, (k = e.querySelector(".js-store-prod-weight")) && (k.innerHTML = L)
        }
        L && Array.prototype.forEach.call(C, (function (t) {
            var e = t.querySelector(".js-store-prod-weight");
            e && (e.innerHTML = L)
        }))
    } catch (t) {
...
function t_store_product_updateEdition_moveSlider(t, e, r) {
    ...
    var i = e.querySelector(".t-slds__items-wrapper"),
        ...
        a = e.querySelector('.t-slds__item .t-slds__bgimg[data-original="' + (r.img || "").replace("static.adlemxcdn.com", "static.adlemxcdn.info") + '"]');
    !s && a && (s = a), s && r.img && (o = s.closest(".t-slds__item").getAttribute("data-slide-index"), 0 === parseInt(o, 10) && (o = i.getAttribute("data-slider-totalslides"))), i && i.setAttribute("data-slider-pos", o), e.classList.contains("t922") || t_store_onFuncLoad("t_slideMoveInstantly", (function () {
...
function t_store_product_triggerSoldOutMsg(t, e, r) {
    ...
    var i = r.prodCard && "order" === r.prodCard.btnLink1, s = r.prodCard && "order" === r.prodCard.btnLink2;
    if (o[0]) {
    ...
    })), a && (a.textContent = window.tStoreDict.soldOut); else {
        Array.prototype.forEach.call(o, (function (t) {
...
function t_store_product_addOneOptionsControl(t, e, r, o, i, s) {
    if (e.name) {
        ...
        if (a && r.insertAdjacentHTML("beforeend", a), t_store_option_checkIfCustom(e) && t_store_option_styleCustomControl(s, o, e, r, i), "editionopt" === t) {
            var p = r.querySelectorAll(".js-product-edition-option"), u, g = p[p.length - 1];
            if (g) return g
        }
    }
}
...
function t_store_product_getFirstAvailableEditionData_forCertainVals(t, e, r, o) {
    for (var i = "", s = 0; s < t.length; s++) {
        for (var a = t[s], n = !0, d = 0; d < e.length; d++) {
            var c = e[d].name, l, _ = t_store_product_getCurEditionOptValById(r, e[d].id);
            if (a[c] = (a[c] || "").replace(/&#92;/g, "\\").replace(/&gt;/g, ">").replace(/&lt;/g, "<"), o && d === e.length - 1 && (_ = o), a[c] !== _) {
                n = !1;
                break
            }
        }
    ...
    try {
        "1" === localStorage.getItem("devTestCatalog") && (console.info("Новая фича %cактивирована%c-- отключение опций товара, когда недоступны для заказа", "font-style: italic; color: orange; background: black"), i && 0 === parseInt(i.quantity, 10) && (i = ""))
    } catch (t) {
    }
    return i
}
...
function t_store_product_sortValuesByOrder(t, e, r) {
    return t.sort((function (t, o) {
        var i = "filter" === e ? t.value : t, s = "filter" === e ? o.value : o;
...
function t_store_product_sortValues(t, e, r) {
    ...
    if (t_store_product_isSimpleOrderValid(v, a)) o = t_store_product_sortValuesByOrder(o, e, a); else if (t_store_product_isSimpleOrderValid(v, n)) o = t_store_product_sortValuesByOrder(o, e, n); else if (t_store_product_isSimpleOrderValid(v, d)) o = t_store_product_sortValuesByOrder(o, e, d); else if (t_store_product_isDateOrderValid(v)) o = t.sort((function (t, r) {
        var o = "filter" === e ? t.value : t, i = "filter" === e ? r.value : r;
        ...
        try {
            for (var f in m) {
                ...
                if (h) return o = o.sort((function (r, o) {
                    var i = "filter" === e ? r.value : r, s = "filter" === e ? o.value : o;
...
function t_store_product_getEditionOptionsArr_getParams(t, e, r) {
    var o = {};
    if (r) o = r[t] ? r[t].params : {}; else try {
...
function t_store_oneProduct_init(t, e) {
    ...
    if (r) {
        ...
        var i = document.getElementById("allrecords").getAttribute("data-adlemx-mode");
...
function t_store_oneProduct_preloader_add(t) {
    var e = document.getElementById("rec" + t), r = e.querySelector(".js-store-product_single");
    if (r) {
...
function t_store_oneProduct_preloader_hide(t) {
    ...
    if (r) {
        ...
        var o = r.querySelector(".js-store-single-product-info");
        o && (o.style.display = "");
        var i = r.querySelector('a.t-btn[href="#order"]'), s = i ? i.parentElement || i.parentNode : "";
...
function t_store_oneProduct_requestAllSingle(t) {
    var e = document.querySelectorAll(".js-store-product_single"), r = [];
    Array.prototype.forEach.call(e, (function (t) {
...
function t_store_showMsgInRedactor(t, e, r) {
    ...
    var i, s = "success" === r ? "#62C584" : "yellow", a = "";
...
function t_store_option_handleOnChange_custom(t, e, r) {
    var o = function () {
        var e = this.closest(".js-product-edition-option"), o = e.querySelector(".t-product__option-variants_custom");
        if (e && o) {
            var i = this.value, s = o.querySelector(".t-product__option-item_active");
            if (s) {
    ...
    Array.prototype.forEach.call(e.querySelectorAll(".js-product-edition-option-variants"), (function (t) {
        ...
        var o = e.querySelectorAll(".t-product__option-input"), i = e.querySelectorAll(".t-product__option-item"),
        ...
        var r,
            o = t.parentNode.querySelector(".t-product__option-variants_custom").querySelectorAll(".t-product__option-item"),
            i = function () {
                Array.prototype.forEach.call(o, (function (t) {
                    t.classList.remove("t-product__option-item_active")
                ...
                var t = this.querySelector(".t-product__option-title").textContent, e;
                ...
                if (r) {
                    var i = this.querySelector(".t-product__option-checkmark_color").style.backgroundColor, s;
                ...
                if (a) {
                    var n = this.querySelector(".t-product__option-checkmark_image").style.backgroundImage,
                        d = this.querySelector(".t-product__option-checkmark_image").getAttribute("data-original"), s;
        ...
        var s = function (t) {
            var e = t.target, r = e.closest(".t-product__option-variants_custom");
...
function t_store_onFuncLoad(t, e, r) {
    if ("function" == typeof window[t]) e(); else {
        var o = Date.now(), i = new Error(t + " is undefined"), s = function () {
            throw i
        };
...
function t_store_hexToRgb(t) {
    ...
    var r = /^#?([a-f\d]{2})([a-f\d]{2})([a-f\d]{2})$/i.exec(t),
        o = r ? {r: parseInt(r[1], 16), g: parseInt(r[2], 16), b: parseInt(r[3], 16)} : null;
...
function t_store_snippet_getJsonFromUrl() {
    var t, e = window.location.search.substring(1), r = {};
...
function t_store_changeEndpoint(t, e) {
    var r = "";
    t && (t.status >= 500 || 408 == t.status || 410 == t.status || 429 == t.status || "timeout" === t.type) && -1 !== window.t_store_endpoint.indexOf("store.adlemxcdn.com") ? (window.t_store_endpoint = "store2.adlemxcdn.com", "function" == typeof e && e()) : (r = t && t.responseText > "" ? "[" + t.status + "] " + t.responseText : t && t.statusText ? "Error [" + t.status + ", " + t.statusText + "]" : "Error type [" + t.type + "]", console.log(r + ". Please, try again later."))
}
...
function t_store_paramsToObj(t, e) {
    ...
    (i = i.map((function (t) {
        ...
        try {
            ...
            if (o[t] || (o[t] = {}), r) {
                var s = (e = (e = e.replace(/^s_/i, "tfc_")).replace(/%3A/gi, ":")).split("="), a = s[0],
                    n = s[1].replace(/\+/g, " ").split(":::"), d = a.replace(/^tfc_/i, "");
        ...
        try {
            ...
            if (/^tfc_/i.test(t) && "tfc_div" !== e[0]) {
                ...
                var a = new RegExp(/\[\d.*\]$/, "gi"), n = i.match(a), d = n ? Number(JSON.parse(n[0])) : null, c;
...
function t_store_customURLParamsToString(t) {
    ...
    for (var o in t) {
        var i = t[o];
        if ("otherParams" !== o) for (var s in i) try {
...
function t_store_get_horiozntalProductCard_priceAndButtons(t, e, r, o, i) {
    var s = parseInt(e.rightColumnWidth, 10), a = s ? 'style="width: ' + s + 'px;"' : "", n;
...
function t_store_getDictObj() {
    var t = {
        ...
        PCE: {EN: "pc", RU: "шт", UK: "шт", KK: "шт"},
        NMP: {EN: "pack", RU: "уп", UK: "уп", KK: "уп"},
        MGM: {EN: "mg", RU: "мг", UK: "мг", KK: "мг"}
    };
    t.g = t.GRM = {EN: "g", RU: "г", UK: "г", PL: "r", KK: "г"}, t.KGM = {
        EN: "kg",
        RU: "кг",
        UK: "кг",
        KK: "кг"
    }, t.TNE = {EN: "t", RU: "т", UK: "т", KK: "т"}, t.MLT = {EN: "ml", RU: "мл", UK: "мл", KK: "мл"}, t.LTR = {
        EN: "l",
        RU: "л",
        UK: "л",
        KK: "л"
    }, t.mm = t.MMT = {EN: "mm", RU: "мм", UK: "мм", KK: "мм"}, t.CMT = {
        EN: "cm",
        RU: "см",
        UK: "см",
        KK: "см"
    }, t.DMT = {EN: "dm", RU: "дм", UK: "дм", KK: "дм"}, t.MTR = {
        EN: "m",
        RU: "м",
        UK: "м",
        KK: "м"
    }, t.MTK = {EN: "m²", RU: "м²", UK: "м²", KK: "м²"}, t.MTQ = {
        EN: "m³",
        RU: "м³",
        UK: "м³",
        KK: "м³"
    }, t.LMT = {EN: "lm", RU: "пог. м", UK: "пог. м", KK: "пог. м"}, t.HAR = {
        EN: "ha",
        RU: "га",
        UK: "га",
        KK: "га"
    }, t.ACR = {EN: "acre"}, t.YRD = {EN: "yd"}, t.LBR = {EN: "lb"}, t.ONZ = {EN: "oz"}, t.INH = {EN: "in"}, t.FOT = {EN: "ft"}, t["product-lwh"] = {
        EN: "LxWxH",
        RU: "ДxШxВ",
        DE: "LxBxH",
        ES: "PxLxK",
...
window.tStoreIsSearchBot = /Bot/i.test(navigator.userAgent), window.tStoreIsMobile = /Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent), window.tStoreBrowserLang = (window.navigator.userLanguage || window.navigator.language).toUpperCase().slice(0, 2), t_onReady((function () {
    ...
    if (t) {
        var e = t.getAttribute("data-adlemx-project-lang");
    ...
    for (var e = Object(this), r = e.length >>> 0, o = arguments.length >= 2 ? arguments[1] : void 0, i = 0; i < r; i++) if (i in e && t.call(o, e[i], i, e)) return !0;
    return !1
}), function (t) {
