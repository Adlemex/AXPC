function t_falladv__handleDomTimeOut() {
    if ("loading" == document.readyState && "object" == typeof window.performance && null !== document.head.querySelector('script[src^="https://static.adlemxcdn."]')) {
        var t = window.performance.getEntriesByType("resource"), e = "";
        if (t.forEach((function (t) {
            t.name.indexOf("https://static.adlemx.") > -1 && t.startTime > 0 && (e = "ok")
        })), "ok" != e) {
...
function t_falladv__reloadSRC(t) {
    ...
    if (!("LINK" != e && "SCRIPT" != e && "IMG" != e || ("LINK" == e && (n = t.getAttribute("href")), "SCRIPT" != e && "IMG" != e || (n = t.getAttribute("src")), "string" != typeof n || "IMG" == e && -1 !== n.indexOf("/-/empty/")))) {
        if (0 === n.indexOf("https://static.adlemx.info/")) i = n.replace("https://static.adlemxcdn.info/", "https://static3.adlemxcdn.info/"); else if (0 === n.indexOf("https://static.adlemxcdn.com/")) i = n.replace("https://static.adlemxcdn.com/", "https://static3.adlemxcdn.com/"); else if (0 === n.indexOf("https://ws.adlemxcdn.com/")) {
            var c = n.split("/");
            i = "/" + c[c.length - 1]
        }
        if (i.indexOf("/css/fonts-adlemxsans") > 0 && (i = i.replace(".css", ".s3.css")), "" != i) {
            if ("SCRIPT" == e) {
