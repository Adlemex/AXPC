window.Adlemx = window.Adlemx || {}, function () {
    function e() {
        ...
        try {
            var a = document.getElementById("allrecords"), i = a ? a.getAttribute("data-adlemx-cookie") : null;
            a && "no" === i || Adlemx.saveUTM()
        } catch (e) {
        }
        ...
        function d(e) {
            ...
            if (e.target && t) {
                var r = t.getAttribute("data-adlemx-event-name"), a = t.textContent, i = t.getAttribute("href") || "",
                    o = t.getAttribute("target");
                if (!r) {
                    var d = t.closest(".r"), c;
                    r = "/adlemx/click/" + (d ? d.getAttribute("id") : "") + "/?url=" + i
                }
                if (Adlemx.sendEventToStatistics(r, a), "http" === i.substring(0, 4) && -1 === i.indexOf(".typeform.com/")) return window.setTimeout((function () {
                    var e = "", t = "";
                    if ("_blank" === o) {
                        if (-1 !== i.indexOf("?") && (e = i.split("?"), i = e[0], -1 !== (e = e[1]).indexOf("#") && (e = e.split("#"), i = i + "#" + e[1], e = e[0]), e = e.split("&")), document.getElementById("adlemxredirectform") ? (document.getElementById("adlemxredirectform").setAttribute("method", "GET"), document.getElementById("adlemxredirectform").setAttribute("action", i)) : document.body.insertAdjacentHTML("beforeend", '<form id="adlemxredirectform" target="_blank" method="GET" action="' + i + '" style="display:none;"></form>'), t = "", e.length > 0) for (var r in e) {
                            var a = e[r].indexOf("=");
                            if (a > -1) {
                        ...
                        if ("" === t) window.open(i, "_blank"); else {
                            var n = document.getElementById("adlemxredirectform");
    ...
    Adlemx.sendEcommerceEvent = function (e, t) {
...
| (_| |  __/\ V /  __/ | (_) | |_) |  __/ |    | (_| | (_| | |  __/ | | | | |>  <
 \__,_|\___| \_/ \___|_|\___/| .__/ \___|_|     \__,_|\__,_|_|\___|_| |_| |_/_/\_\
                             |_|
    */
        "add" !== e && "remove" !== e || (r = "/adlemx/cart/" + e + "/", n > 0 && (r += "" + n), m > 0 ? r += "-u" + m : l > 0 && (r += "-" + l)), "detail" === e && (r = "/adlemx/product/detail/", m > 0 ? r += m + "/" : (n > 0 && (r += "r" + n), l > 0 && (r += "-l" + l))), "purchase" === e && (r = "/adlemx/rec" + n + "/payment/"), (p = {ecommerce: {}}).ecommerce[e] = {products: o}, Adlemx.sendEventToStatistics(r, a, p, i)
    }, Adlemx.sendEventToStatistics = function (e, t, r, a) {
        ...
        if (u = d.getAttribute("data-adlemx-currency") ? d.getAttribute("data-adlemx-currency") : p && p.getAttribute("data-project-currency-code") ? p.getAttribute("data-project-currency-code") : "RUB", r || (r = window.location.href), (a = a ? parseFloat(a) : 0) > 0) if (window.dataLayer || (window.dataLayer = []), -1 !== e.indexOf("/adlemx/") && -1 !== e.indexOf("/payment/") && window.adlemxForm && window.adlemxForm.orderIdForStat > "") r = {
            ecommerce: {
                purchase: {
                    actionField: {
                        id: window.adlemxForm.orderIdForStat,
                        revenue: window.adlemxForm.amountForStat
                    }, products: window.adlemxForm.arProductsForStat
                }
            }
        }, window.adlemxForm.adlemxpayment && window.adlemxForm.adlemxpayment.promocode && (r.ecommerce.purchase.actionField.coupon = window.adlemxForm.adlemxpayment.promocode), r.event = "purchase"; else if (r && r.ecommerce && (r.ecommerce.add && r.ecommerce.add.products ? o = r.ecommerce.add.products : r.ecommerce.remove && r.ecommerce.remove.products ? o = r.ecommerce.remove.products : r.ecommerce.detail && r.ecommerce.detail.products && (o = r.ecommerce.detail.products), o && o.length > 0)) {
        ...
        try {
            ...
            }); else gtag("event", e, {event_category: "adlemx", event_label: t, value: a})
        } catch (e) {
        }
        if (window.ga && "adlemx" !== window.mainTracker && "gtag" !== window.mainTracker) if (i) if (r && r.event) {
            try {
                if (window.Adlemx.isLoadGAEcommerce || (window.Adlemx.isLoadGAEcommerce = !0, ga("require", "ec")), ga("set", "currencyCode", u), "purchase" === r.event) {
        ...
        if (window.mainMetrika > "" && window[window.mainMetrika] && (i ? a > 0 ? window[window.mainMetrika].hit(e, {
            ...
            if (i) if (-1 === e.indexOf("adlemx/") || -1 === e.indexOf("/payment/") && -1 === e.indexOf("/submitted/")) if (r && r.event && a > 0) if ("addToCart" === r.event && r.ecommerce.add) {
            ...
            } else e.indexOf("adlemx/popup"), window.fbq("track", "ViewContent", {
                content_name: t,
                content_category: e
            }); else e.indexOf("adlemx/popup"), window.fbq("track", "ViewContent", {
                content_name: t,
        ...
        if (void 0 !== window.VK && void 0 !== window.VK.Retargeting && !1 === l) try {
            if (i) {
                ...
                if (r && r.event) if (A = {
                    ...
                    T = "remove_from_cart"
                } else T = "t-remove-product", r.ecommerce.remove[0] && r.ecommerce.remove[0].uid && (T += "-" + r.ecommerce.remove[0].uid); else T = r.event; else if (-1 !== e.indexOf("adlemx/") && -1 !== e.indexOf("/payment/")) T = "t-purchase-" + (E = (E = (E = e.replace("/adlemx/", "")).replace("adlemx/", "")).replace("/payment/", "")); else if (-1 !== e.indexOf("adlemx/") && -1 !== e.indexOf("/submitted/")) T = "t-lead-" + (E = (E = (E = e.replace("/adlemx/", "")).replace("adlemx/", "")).replace("/submitted/", "")); else if (-1 !== e.indexOf("adlemx/popup")) T = "t-" + (E = (E = e.replace("/adlemx/", "")).replace("/", "-")); else if (-1 !== e.indexOf("adlemx/click")) T = "t-" + (E = (E = e.replace("/adlemx/", "")).replace("/", "-")); else T = "t-" + (E = e.replace("/", "-"));
        ...
        "function" == typeof window.adlemxstat && (i ? (e.indexOf("payment") > 0 && e.indexOf("adlemx/form") > -1 && (e = e.replace("adlemx/form", "adlemx/rec")), window.adlemxstat("pageview", {page: e})) : window.adlemxstat("pageview", {page: "/adlemx/event/" + e}))
    }, Adlemx.saveUTM = function () {
        try {
