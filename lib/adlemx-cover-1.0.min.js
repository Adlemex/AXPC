function t_cover__parallax(t) {
    var o = window.innerHeight, r = (window.addEventListener("resize", function () {
...
function t_cover__parallaxUpdate(e, t, o, r) {
    var n = window.pageYOffset, i = e.getBoundingClientRect().top + n, c = e.getBoundingClientRect().top;
...
function cover_init(e) {
    var t = document.getElementById("allrecords"), t = !!t && "yes" === t.getAttribute("data-adlemx-lazy"),
        o = document.getElementById("rec" + e), r = document.getElementById("coverCarry" + e),
    ...
    if (r) {
        ...
        var a = ["mp4", "webm", "youtube"], a = ("yes" === i["video-nocover"] ? a.forEach(function (e) {
            i["video-url-" + e] = ""
...
function t_cover__setCoverParams(e, t, o) {
    var r, n, i = "fixed" === t["cover-parallax"], c = "dynamic" === t["cover-parallax"], a = "yes" === t["bg-base64"];
...
function t_cover__processHTML5Video(n, o, i) {
    ...
    var e = -1 !== o["cover-height"].indexOf("vh") && 100 < parseInt(o["cover-height"], 10),
        t = -1 !== o["cover-height"].indexOf("px") && parseInt(o["cover-height"], 10) > window.innerHeight, c = !1,
        r = (i && (e || t) && (n.style.height = "100vh", c = !0), !o["video-noloop"]), a = !o["video-nomute"];
...
function t_cover__setStylesForCoverVideo(e, t) {
    e.style.backgroundColor = "#000000", e.style.backgroundImage = "youtube" === t ? "" : '', e.setAttribute("data-content-cover-bg", "")
}
...
function t_cover__initCovers() {
    ...
    !!e && "edit" === e.getAttribute("data-adlemx-mode") || (e = document.querySelectorAll(".t-cover__carrier"), Array.prototype.forEach.call(e, function (e) {
...
function t_cover__recalcCoverHeight(e, t) {
    var o, r, n, i, c, a = document.getElementById("rec" + e);
    a && (e = a.querySelector(".t-cover"), o = a.querySelector(".t-cover__carrier"), n = "935" === a.getAttribute("data-record-type"), c = o ? o.getAttribute("data-content-cover-height") : "", r = "y" === a.getAttribute("data-fixed-bg"), e && !n && (n = t_cover__getHeightFromAttr(c), c = t_cover__getPureHeight(e), n = n || c, i = 0, r || (i = e.style.height, e.style.height = "", n = c, i && (e.style.height = i)), c = t_cover__getPureHeight(a.querySelector("div[data-hook-content]")), e = !!o && "100vh" === o.getAttribute("data-content-cover-height"), 300 < c && n < c + 40 || r || (window.t_cover__isMobile || "ontouchend" in document) && t ? (t_cover__setRecalculatedHeight(a, c), t_cover__updateResizeElem(a)) : window.t_cover__isMobile && e && [".t-cover", ".t-cover__filter", ".t-cover__carrier", ".t-cover__wrapper"].forEach(function (e) {
        e = a.querySelector(e);
...
function t_cover__setRecalculatedHeight(t, e) {
    var o = t.querySelector(".t-cover__carrier"),
        ...
        i = window.innerWidth <= 568 ? 40 : 120, c = window.innerWidth <= 568 ? 50 : 100,
        a = (1e3 < (e += i) && (e += c), r < e ? e : r), d = 0,
...
function t_cover__updateResizeElem(e) {
    ...
    !o || "yes" !== o.getAttribute("data-adlemx-lazy") || (t = e.querySelector(".t-cover__carrier"), t_onFuncLoad("t_lazyload_updateResize_elem", function () {
        t_lazyload_updateResize_elem(t)
    }))
}

function t_cover__checkIsFixForBgNeeded(e) {
    var e = document.getElementById("rec" + e), t = e ? e.querySelector(".t-cover__carrier") : null;
    if (!t) return !1;
    var e = "y" === e.getAttribute("data-fixed-bg"), o = (o = ["mp4", "webm", "youtube"]).map(function (e) {
        return t.getAttribute("data-content-video-url-" + e)
    }), r = "fixed" === t.getAttribute("data-content-cover-parallax"), o = o.some(function (e) {
        return e
...
function t_cover__fixBgFixedStyles(e) {
    var t = document.getElementById("rec" + e), e = t_cover__checkIsFixForBgNeeded(e),
        o = t ? t.querySelector(".t-cover") : null, r = t ? t.querySelector(".t-cover__container") : null;
...
function t_cover__scrollToNextSection(e) {
    ...
    var o = window.pageYOffset, r = (e - o) / 30, n = window.pageYOffset, i = setInterval(function () {
