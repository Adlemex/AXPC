...
function t_skiplink__addAnchor() {
    var e = document.querySelectorAll('[data-menu="yes"]'), t = document.getElementById("t-header"),
        n = '<div id="t-main-content"></div>';
    if (t && t.insertAdjacentHTML("afterend", n), 0 < e.length && !t) {
        t = e[0].parentNode;
        if (1 === e.length) t.insertAdjacentHTML("afterend", n); else for (var i = 0; i < e.length; i++) {
...
function t_skiplink__dict(e) {
    var t = [];
    t.skiplink = {EN: "To main content", RU: "К основному контенту"}, t.skiplinkAriaLabel = {
        EN: "Skip to main content",
        RU: "К основному контенту"
    };
    var n = document.querySelector("html").getAttribute("lang"), n = n ? n.toUpperCase() : window.browserLang;
