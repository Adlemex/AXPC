...
function t_fallback__handleTimeout() {
    "loading" == document.readyState && "object" == typeof window.performance && null !== document.head.querySelector('script[src^="https://static.adlemxcdn."]') && (t_fallback__loadAdvancedJS(), setTimeout((function () {
...
function t_fallback__loadAdvancedJS() {
    if (!0 !== window.t_isfalladvstartload) {
        ...
        t.open("GET", "lib/adlemx-fallback-advanced-1.0.min.js", !0), t.onreadystatechange = function () {
